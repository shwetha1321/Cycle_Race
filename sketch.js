...
mainCyclist.addAnimation("SahilNRunning",mainRacerImg2);
mainCyclist.scale=0.07;
  
//set collider for mainCyclist
mainCyclist.setCollider("rectangle",0,0,1200,600);
...
function draw() {
  ...
  stroke("maroon")
  fill("white");
  text("Press UP arrow to restart!",gameOver.x-145,gameOver.y+50);
    ...
    mainCyclist.changeAnimation("SahilNRunning",mainRacerImg2);
